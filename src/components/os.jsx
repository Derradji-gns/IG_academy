    ...
    <div class="w-[80%] lg:w-full mr-auto ml-auto group flex flex-col h-full bg-white border   border-gray-200 shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-xl  ">
      ...
      <div class="p-4 md:p-6">
        ...
        <p class="mt-3 text-gray-500 dark:text-neutral-500">
         Operating Systems – Documentation explaining OS concepts, architecture, and process management.
        </p>
      </div>
      <div class="mt-auto rounded-b-xl flex border-t border-gray-200 divide-x divide-gray-200  bg-white">
        <a class="w-full py-3 px-4 inline-flex justify-center items-center rounded-bl-xl gap-x-2 text-sm font-medium rounded-es-xl text-white rounded-br-xl   bg-red-500   focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none    hover:bg-red-600 " href={file.url}>
          Read
        </a>
